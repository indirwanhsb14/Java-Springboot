public class Binary {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(("Key " + key1 + " index index " + i));
        System.out.println(("Key " + key2 + " index index " + j));
        System.out.println(("Key " + key3 + " index index " + k));
        System.out.println(("Key " + key4 + " index index " + l));
