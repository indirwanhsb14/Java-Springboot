...
import com.demo.auth.controller.BlogController;
import com.demo.auth.model.Blog;
import com.demo.auth.repository.BlogRepository;

@RunWith(SpringRunner.class)
@SpringBootTest
public class BelajarAuthApplicationTests {
